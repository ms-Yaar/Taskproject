...
class BugsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bug" do
    assert_difference("Bug.count") do
      post bugs_url, params: { bug: { deadline: @bug.deadline, screenshot: @bug.screenshot, status: @bug.status, title: @bug.title, type: @bug.type } }
    end
  ...
  test "should update bug" do
    patch bug_url(@bug), params: { bug: { deadline: @bug.deadline, screenshot: @bug.screenshot, status: @bug.status, title: @bug.title, type: @bug.type } }
